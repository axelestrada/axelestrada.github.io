...
import {
  ...
  StackOverflowIcon,
  MongoDBIcon,
} from "@/icons"; // Import icons from local directory

export const Skills = () => {
  const [activeTab, setActiveTab] = useState("home");

  // Configuración de bordes: "b" = abajo, "r" = derecha, "l" = izquierda, "t" = arriba
  const cellBorders = [
    "border-b-3",
  ...
  // Mapeo de habilidades según la pestaña activa
